...
export const checkapi = (data) => {
  return async (dispatch) => {
    const res = await axios.post(
      "https://book2say.com/taxibooking/Authentication/checkapi",
      data,
      {}
    );
    return res;
...
export const iftripnotresponded = (data, navigation) => {
  return async (dispatch) => {
    const res = await axios.post(`${storeurl}iftripnotresponded`, data, {});
...
export const deleteuser = (data) => {
  return async (dispatch) => {
    const res = await axios.post(`${storeurl}delete_user`, data, {});
